...
#Asimov flux NO
def FluxNO_ResEn_teo_bg(x, flux, bkg, T13, T12, M21, M3l, dist, N, A, B,C): #x in MeV
...
# Asimov flux IO
def FluxIO_ResEn_teo_bg(x, flux, bkg, T13, T12, M21, M3l, dist, N, A, B, C):
    #Theorical flux of anti-nu
    F=flux
    #IBD cross section
    Ee=x-1.293
...
# Asimov flux NO without background
...
# Asimov flux IO without background
...
def FluxNO_ResEn(x, flux, bkg, T13, T12, M21, M3l, dist, N, A, B, C):
    #Theorical flux of anti-nu
    F=flux
    #IBD cross section
    Ee=x-1.293
...
def FluxIO_ResEn(x, flux, bkg, T13, T12, M21, M3l, dist, N, A, B, C):
    #Theorical flux of anti-nu
    F=flux
    #IBD cross section
    Ee=x-1.293
